...
if __name__ == "__main__":
    ...
    if params['mode']==1: #intial training
        ...
        train_loader = data.DataLoader(dataset=trainset, batch_size=config.BATCH_SIZE, shuffle=True,  num_workers=8)
        test_loader_1 = data.DataLoader(dataset=testset_1, batch_size=config.BATCH_SIZE, shuffle=True,  num_workers=8)
        test_loader_2 = data.DataLoader(dataset=testset_2, batch_size=config.BATCH_SIZE, shuffle=True,  num_workers=8)
